...
public class Vtiger {
    ...
    public static String centralizeString(String words, int maxLength) {
        ...
        for (String word : wordArray) {
            ...
            //appliying the logic for formatting and allignment the string
    ...
    private static String centralizeLine(String line, int maxLength) {
        ...
        int leftPadding = 33;    //Setting the desired left paddin
    ...
    public static void main(String[] args) {
        ...
        String formattedString = centralizeString(words, maxLength);
